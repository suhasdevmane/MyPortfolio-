...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Python", "JavaScript", "TypeScript", "Java", "C", "C++", "Go", "Shell Script", "LaTeX"] },
    { title: "Frontend Technologies", items: ["HTML5", "CSS3", "React", "Angular", "Angular.js", "Bootstrap", "jQuery"] },
    { title: "Backend & APIs", items: ["NodeJS", "Express.js", "Flask", "Socket.io", "JWT", "Postman", "Swagger"] },
  ],
  [
    { title: "Databases & Storage", items: ["MongoDB", "PostgreSQL", "MySQL", "Cassandra", "SQLite", "IndexedDB"] },
    { title: "Data Science & ML", items: ["PyTorch", "TensorFlow", "Keras", "scikit-learn", "Pandas", "NumPy", "SciPy", "Plotly"] },
    { title: "Cloud & DevOps", items: ["Docker", "Kubernetes", "Google Cloud", "OpenStack", "Nginx", "Anaconda", "NPM"] },
  ],
  [
    {
      title: "IoT & Smart Buildings",
      items: ["ThingsBoard", "Brick Schema", "Sensor Networks", "Arduino", "Raspberry Pi", "IoT Protocols", "MQTT"],
    },
    {
    ...
    },
    {
      ...
      items: ["Data Engineering", "ETL Pipelines", "Database Administration", "System Performance", "Technical Support", "Git", "Trello", "Canva"],
    },
  ],
];
